...
namespace ClassroomProject
{
    class StartUp
    {
        static void Main(string[] args)
        {
            ...
            var numsss = classroom.Count;
            Console.WriteLine(numsss);
            // Initialize entities
            int num = classroom.GetStudentsCount();
            ...
            num = classroom.GetStudentsCount();
            Console.WriteLine(num);
            // Print Student
            ...
            numsss = classroom.Count;
            Console.WriteLine(numsss);

            // Dismiss Student
            string dismissed = classroom.DismissStudent("Peter", "Ivoanov");
