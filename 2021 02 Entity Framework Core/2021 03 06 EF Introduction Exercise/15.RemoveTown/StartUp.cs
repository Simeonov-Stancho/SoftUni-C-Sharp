...
namespace SoftUni
{
    public class StartUp
    {
        ...
        {
            var employeesProjectById = context.EmployeesProjects
            ...
            foreach (var ep in employeesProjectById)
            {
        ...
        {
            var townByID = context.Towns
                .Where(t => t.Name == "Seattle")
                .FirstOrDefault();

            var addressById = context.Addresses
                 .Where(a => a.Town.Name == "Seattle")
                 .ToList();

            var emploeesOnThisAddress = context.Employees
                .Where(e => e.Address.Town.Name == "Seattle")
                .ToList();

            int count = addressById.Count();

            foreach (var a in emploeesOnThisAddress)
            {
                a.AddressId = null;
            }

            foreach (var a in addressById)
            {
                context.Addresses.Remove(a);
            }

            context.Towns.Remove(townByID);
            context.SaveChanges();
