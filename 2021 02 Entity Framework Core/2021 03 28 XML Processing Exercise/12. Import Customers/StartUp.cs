...
namespace CarDealer
{
    public class StartUp
    {
        ...
        public static void Main(string[] args)
        {
            ...
            //CleanAndCreateDb(db, inputSuppliersXml, inputPartsXml, inputCarXml, inputCustomersXml);
        }
        ...
        public static void CleanAndCreateDb(CarDealerContext context, string suppliersXml, string partsXml, string carXml, string customersXml)
        {
