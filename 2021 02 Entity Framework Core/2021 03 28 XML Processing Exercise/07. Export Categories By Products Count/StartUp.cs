...
namespace ProductShop
{
    public class StartUp
    {
        ...
        public static void Main(string[] args)
        {
            ...
            //string soldProductsXml = GetSoldProducts(db);
            //File.WriteAllText($"{ResultDirectoryPath}/users-sold-products.xml", soldProductsXml);

            //07. Export Categories By Products Count
            string categoriesByCountXml = GetCategoriesByProductsCount(db);
            File.WriteAllText($"{ResultDirectoryPath}/categories-by-products.xml", categoriesByCountXml);
        ...
        public static string GetSoldProducts(ProductShopContext context)
        {
            ...
            var xmlRoot = new XmlRootAttribute("Users");
            var xmlSerializer = new XmlSerializer(typeof(List<UserExportDto>), xmlRoot);
        ...
        public static string GetCategoriesByProductsCount(ProductShopContext context)
        {
            ...
            var xmlRoot = new XmlRootAttribute("Categories");
            var xmlSerializer = new XmlSerializer(typeof(List<CategoryExportDto>), xmlRoot);
